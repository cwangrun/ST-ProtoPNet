...
# def resnet50_features(pretrained=False, **kwargs):   # pretrained on ImageNet for full Dogs
...
def resnet50_features(pretrained=False, inat=True, **kwargs):  # pretrained on iNaturalist2017 for full CUB
    """Constructs a ResNet-50 model.
    Args:
